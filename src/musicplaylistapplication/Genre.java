...
public class Genre implements PlayListInterface{
  // Genre name
    ...
    // Constructor for creating a Genre object with a given genre name.
    public Genre(String genre) {
        this.genre = genre;
    }

    // Getter method for retrieving the genre name.
    ...
    // Method to add a song to the genre playlist.
    @Override
    ...
    // Method to delete a song from the genre playlist.
    @Override
    ...
    // Method to search for a song in the genre playlist by its title.
    @Override
    ...
    // Method to print the genre playlist.
    @Override
    public void printPlaylist() {
        StringBuilder playlistText = new StringBuilder();
        Node current = head;
        // Traverse the list to build the playlist text
        while (current != null) {
    ...
    // Method to count the number of songs in the genre playlist.
    @Override
    ...
    // Method to check if a song with a given title exists in the genre playlist.
